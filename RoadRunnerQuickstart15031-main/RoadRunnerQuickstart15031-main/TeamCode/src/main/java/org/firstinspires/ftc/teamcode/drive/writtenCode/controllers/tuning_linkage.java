...
import org.firstinspires.ftc.teamcode.drive.writtenCode.controllers.SimplePIDController;
...
public class tuning_linkage extends LinearOpMode {
    ...
    public static double Kd = 0.0024;
    public static double maxSpeed = 1;
    public static double RetractedPosition = 0 , ExtendedPosition = 3080;
