...
public class SlidesController {
    ...
    public static int bsk_high_position = -52500;
    ...
    SimplePIDController slidesPID_rung = null;
    ...
    public static double KpR = 0.00025;
    ...
    public void update(int slides_position, int runto_target)
    {
        ...
        if (KpR!=PID.p || KdR!=PID.d || KiR!=PID.i || maxSpeed !=PID.maxOutput && PID==slidesPID_rung)
        {
            PID.p = KpR;
            PID.d = KdR;
            PID.i = KiR;
